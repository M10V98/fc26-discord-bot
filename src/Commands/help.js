            ...
            new EmbedBuilder()
                ...
                .setDescription(
                    [
                        ...
                        "`/player achievements @user` shows earned and locked milestones.",
                        "`/player form @user mode:Divisions|Competitive` shows last 5/10 personal match form.",
                        "`/player compare` compares goals, assists, average rating, and win rate for two claimed players.",
                        ...
                        "`/quiz start` starts a timed football quiz question for XP rewards.",
